...
public class GameManager : MonoBehaviour
{
    ...
    public AudioManager_v2 audioManager;
    ...
    private void Init()
    {
        ...
        if (!audioManager) audioManager = gameObject.GetComponentInChildren<AudioManager_v2>();
    ...
    private void OnSceneLoaded(Scene _scene, LoadSceneMode _mode) //Determines what scripts are loaded when the next scene loads. Double check eScene names with actual Scenes in Build in Build Settings.
    {
        ...
        switch (curScene)
        {
            case eScene.CTS_FrontEndScene:
                ...
                Cursor.visible = true;
                audioManager.PlayMusic(eMusic.titleMusic);
                break;
    ...
    public void GetSpawnLocations()
    {
        ...
        if (playerProgressionUnlock.newGame || !playerProgressionUnlock.haveSavedFile)
        {
