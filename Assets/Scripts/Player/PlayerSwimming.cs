...
public class PlayerSwimming : MonoBehaviour
{
    ...
    {
        // Using the Unity Crest Package, when player is below the water surface, this function is called once
        isSwimming = true;
    ...
    {
        // Using the Unity Crest Package, when player is above the water surface, this function is called once
        isSwimming = false;
        rigidBody.constraints = RigidbodyConstraints.FreezeAll;
         Debug.Log($"Player is below water {isSwimming}");
